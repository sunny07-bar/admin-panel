...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: <ListIcon />,
    subItems: [
      { name: "Categories", path: "/menu/categories", pro: false },
      { name: "Items", path: "/menu/items", pro: false },
    ],
  },
  {
    icon: <CalenderIcon />,
    ...
    subItems: [
      ...
      { name: "Tickets", path: "/events/tickets", pro: false },
      { name: "Scan Tickets", path: "/events/scan", pro: false },
    ],
  },
  {
    icon: <PageIcon />,
  ...
  },
  {
    ...
    icon: <TableIcon />,
    subItems: [
      { name: "All Reservations", path: "/reservations", pro: false },
      { name: "Special Hours", path: "/reservations/special-hours", pro: false },
    ],
  },
  {
    icon: <TableIcon />,
